...
- Deploy `backend/firebase-rules/firestore.rules` and verify every role flow in Firebase Emulator or staging.
...
- Keep Firestore indexes deployed from `backend/firebase-rules/firestore.indexes.json`.
